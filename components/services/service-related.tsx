...
export function ServiceRelated({ contacts, jobs }: ServiceRelatedProps) {
  return (
    <div className="mt-6 grid gap-6 xl:grid-cols-2">
      <Card>
        ...
        {contacts.length === 0 ? (
          <div className="mt-4">
            <EmptyMessage>このサービスに紐づく担当者はまだありません。</EmptyMessage>
          </div>
        ) : (
            ...
            <table className="w-full border-collapse text-left text-sm">
              <thead className="bg-surface text-muted">
                <tr>
                  ...
                  <th className="px-3 py-2 font-medium">関連会社</th>
                </tr>
              </thead>
      ...
      <Card>
        ...
        {jobs.length === 0 ? (
          <div className="mt-4">
            <EmptyMessage>このサービスに紐づく求人はまだありません。</EmptyMessage>
          </div>
        ) : (
          <div className="mt-4 overflow-hidden rounded-md border border-border">
            <table className="w-full border-collapse text-left text-sm">
